...
class ChildCounter extends Component
{
    ...
    public function render()
    {
        ...
        <div>
            ...
            <span wire:loading wire:target="increment">Same method in child loading...</span>
            <span wire:loading wire:target="$parent.increment, test">Parent and child loading...</span>
        </div>
        HTML;
    }
}
