...
Below is an example of wrapping an element used by a third-party library in `wire:ignore` to that Livewire doesn't tamper with the HTML generated by the library:
