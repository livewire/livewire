...
export default class Message {
    ...
    invokeOnSuccess() {
        ...
        if (Object.hasOwn(this.responsePayload.effects, 'returns') && this.responsePayload.effects['returns']) {
            this.pendingReturns = this.responsePayload.effects['returns']
        }

        if (Object.hasOwn(this.responsePayload.effects, 'returnsMeta') && this.responsePayload.effects['returnsMeta']) {
