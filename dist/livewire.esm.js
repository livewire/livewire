...
${expression ? 'Expression: "' + expression + '"\n\n' : ""}`, el);
    ...
    magic("model", (el, { cleanup: cleanup2 }) => {
      let func = generateModelAccessor(el, cleanup2);
      Object.defineProperty(func, "closest", { get() {
        let func2 = generateModelAccessor(el.parentElement, cleanup2);
        func2._x_modelAccessor = true;
        return accessor(func2);
      } });
...
var require_module_cjs6 = __commonJS({
  "../alpine/packages/anchor/dist/module.cjs.js"(exports, module) {
    ...
    function src_default(Alpine22) {
      ...
      Alpine22.directive("anchor", Alpine22.skipDuringClone((el, { expression, modifiers, value }, { cleanup: cleanup2, evaluate: evaluate2 }) => {
