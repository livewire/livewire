...
function generateEntangleFunction(component, cleanup2) {
  console.log("generateEntangleFunction", cleanup2);
  if (!cleanup2)
    cleanup2 = () => {
    };
  return (name, live) => {
...
wireProperty("$entangle", (component) => (name, live = false) => {
  let [utilities, cleanup2] = import_alpinejs2.default.getElementBoundUtilities(component.el);
  return generateEntangleFunction(component, cleanup2)(name, live);
});
