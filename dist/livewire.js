...
${expression ? 'Expression: "' + expression + '"\n\n' : ""}`, el);
  ...
  magic("model", (el, { cleanup: cleanup22 }) => {
    let func = generateModelAccessor(el, cleanup22);
    Object.defineProperty(func, "closest", { get() {
      let func2 = generateModelAccessor(el.parentElement, cleanup22);
  ...
  function handleFormResets(el, cleanup22) {
    if (el.form) {
