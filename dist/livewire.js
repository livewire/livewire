  ...
  _createClass(DirtyManager, [{
    ...
    value: function registerListener() {
      ...
      this.component.el.addEventListener('input', function (e) {
        ...
        var isDirty = el.valueFromInput() != _this2.component.data[el.directives.get('model').value];
...
/* harmony import */ var _LoadingManager__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./LoadingManager */ "./src/js/Component/LoadingManager.js");
/* harmony import */ var _DirtyManager__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./DirtyManager */ "./src/js/Component/DirtyManager.js");
...
function () {
  function Component(el, connection) {
    ...
    this.loadingManager = new _LoadingManager__WEBPACK_IMPORTED_MODULE_7__["default"]();
    this.dirtyManager = new _DirtyManager__WEBPACK_IMPORTED_MODULE_8__["default"](this);
    this.initialize();
  ...
  _createClass(Component, [{
    ...
    value: function replaceDom(rawDom) {
      _Store__WEBPACK_IMPORTED_MODULE_6__["default"].beforeDomUpdateCallback();
      this.handleMorph(this.formatDomBeforeDiffToAvoidConflictsWithVue(rawDom.trim()));
      _Store__WEBPACK_IMPORTED_MODULE_6__["default"].afterDomUpdateCallback();
    }
  }, {
  ...
  _createClass(Livewire, [{
    ...
    value: function rescan() {
      ...
      _dom_dom__WEBPACK_IMPORTED_MODULE_1__["default"].rootComponentElementsWithNoParents().forEach(function (el) {
        ...
        _this2.components.addComponent(new _Component__WEBPACK_IMPORTED_MODULE_2__["default"](el, _this2.connection));
      });
    }
  }, {
    key: "beforeDomUpdate",
