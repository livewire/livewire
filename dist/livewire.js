...
${expression ? 'Expression: "' + expression + '"\n\n' : ""}`, el);
  ...
  function morph2(component, el, html) {
    ...
    module_default.morph(el, to, {
      updating: (el2, toEl, childrenOnly, skip, skipChildren, skipUntil) => {
        skipSlotContents(el2, toEl, skipUntil);
        if (isntElement(el2))
          return;
        trigger2("morph.updating", { el: el2, toEl, component, skip, childrenOnly, skipChildren, skipUntil });
