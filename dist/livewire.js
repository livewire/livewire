...
function () {
  ...
  _createClass(LoadingManager, [{
    key: "addLoadingEl",
    value: function addLoadingEl(el, value, targetRefs, remove) {
      var _this = this;

      if (targetRefs) {
        targetRefs.forEach(function (targetRef) {
          if (_this.loadingElsByRef[targetRef]) {
            _this.loadingElsByRef[targetRef].push({
              el: el,
              value: value,
              remove: remove
            });
          } else {
            _this.loadingElsByRef[targetRef] = [{
              el: el,
              value: value,
              remove: remove
            }];
    ...
    key: "unsetLoading",
    value: function unsetLoading(loadingEls) {
