...
${expression ? 'Expression: "' + expression + '"\n\n' : ""}`, el);
  ...
  module_default.magic("wire", (el, { cleanup: cleanup2 }) => {
    let component;
    currentElementCleanup = cleanup2;
    return new Proxy(
      {},
      {
        get(target, property) {
  ...
  wireProperty(
    "$get",
    (component) => (property, reactive3 = true) => dataGet(
  ...
  wireProperty(
    "$on",
    (component) => (...params) => listen2(component, ...params)
  );
  ...
  wireProperty(
    "$dispatch",
    (component) => (...params) => dispatch3(component, ...params)
  );
  wireProperty(
    "$dispatchSelf",
    (component) => (...params) => dispatchSelf(component, ...params)
  );
  wireProperty(
    "$dispatchTo",
    () => (...params) => dispatchTo(...params)
  );
  wireProperty(
    "$upload",
    (component) => (...params) => upload(component, ...params)
  );
  wireProperty(
    "$uploadMultiple",
    (component) => (...params) => uploadMultiple(component, ...params)
  );
  wireProperty(
    "$removeUpload",
    (component) => (...params) => removeUpload(component, ...params)
  );
  wireProperty(
    "$cancelUpload",
    (component) => (...params) => cancelUpload(component, ...params)
  );
