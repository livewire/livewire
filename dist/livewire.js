    ...
    value: function handleMorph(dom) {
      ...
      Object(_dom_morphdom__WEBPACK_IMPORTED_MODULE_2__["default"])(this.el.rawNode(), dom, {
        ...
        getNodeKey: function getNodeKey(node) {
          ...
          return node.hasAttribute("key") ? node.getAttribute("key") // If no "key", then first check for "wire:id", then "wire:model", then "id"
  ...
  _createClass(_default, [{
    ...
    value: function payload() {
      return {
        ...
        browserId: _store__WEBPACK_IMPORTED_MODULE_0__["default"].getBrowserId(),
