...
${expression ? 'Expression: "' + expression + '"\n\n' : ""}`, el);
  ...
  on2("directive.init", ({ el, directive: directive3, cleanup: cleanup2, component }) => {
    if (["snapshot", "effects", "model", "init", "loading", "poll", "ignore", "id", "data", "key", "target", "dirty", "scroll"].includes(directive3.value))
      return;
    ...
    if (!directive3.expression || directive3.expression.trim() === "")
      return;
