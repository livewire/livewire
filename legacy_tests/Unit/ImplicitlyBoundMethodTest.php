...
class ImplicitlyBoundMethodTest extends TestCase
{
    ...
    public function call_without_required_parameters_throws_exception()
    {
        ...
        $this->expectExceptionMessage('Unable to resolve dependency [Parameter #0 [ <required> $foo ]] in class LegacyTests\Unit\ContainerTestCallStub');
    ...
    {
        $this->expectException(BindingResolutionException::class);
        $this->expectExceptionMessage('Unable to resolve dependency [Parameter #0 [ <required> $foo ]] in class LegacyTests\Unit\ImplicitlyBoundMethodTest');
